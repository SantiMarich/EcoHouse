...
const Footer = () => {
  return (
    <footer class="bg-green-500 shadow h-160 sm:flex sm:items-center sm:justify-between p-8 sm:p-8 xl:p-10 dark:bg-green-500 antialiased">
      <p class="mb-4 text-xs text-center text-white dark:text-white sm:mb-0">
        &copy; 2024 <a>EcoHouse Inmobiliaria</a>
      </p>
      <div class="flex justify-center items-center space-x-3 mb-0 sm:mb-0 md:mb-0 lg:mb-0 xl:mb-0 ">
        <a
